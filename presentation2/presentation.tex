...
\begin{block}{Part II - Our implementation}
\begin{itemize}
  \item Implementation in \texttt{model.py}
  \item ANN training and default-weight issue
  \item Multi-seed protocol in \texttt{sim\_over\_multiple\_seed.ipynb}
  \item Results and differences vs paper
\end{itemize}
\end{block}
\end{frame}
...
% ===== Slide: workflow =====
\begin{frame}[c]{Modeling workflow in the paper}
...
% ===== Project section =====
\section{Our Project Implementation}

% ===== Slide: implementation overview =====
\begin{frame}[c]{How we implemented the model (\texttt{model.py})}
\small
...
\scriptsize Our pre-training ANN map
...
\scriptsize Our post-training ANN map
...
\begin{frame}[c]{What \texttt{sim\_over\_multiple\_seed.ipynb} does}
\small
...
\begin{frame}[c]{Total cells over time across oxygen levels}
\centering
\begin{columns}[c,onlytextwidth]
\column{0.50\textwidth}
\centering
...
\begin{frame}[c]{Population dynamics across oxygen cases}
\centering
...
\begin{itemize}
  ...
  \item Project files: \texttt{simulation/model.py}, \texttt{simulation/ann\_training.ipynb}, \texttt{simulation/sim\_over\_multiple\_seed.ipynb}.
\end{itemize}
\end{frame}
